...
PUBLIC_URL = "https://smith.langchain.com/public/c5e7a6ad-fdba-478c-88e6-3a388459ce8b/d"
dataset = client.clone_public_dataset(PUBLIC_URL)
print(f"Cloned dataset with id: {dataset.id}")
...
summarization_model = "openai:Qwen/Qwen2.5-32B-Instruct"
summarization_model_max_tokens = 8192


# Replace OpenAI research model
research_model = "openai:Qwen/Qwen2.5-32B-Instruct"  # Qwen local endpoint
research_model_max_tokens = 30000
#research_model = "openai:gpt-5" # "anthropic:claude-sonnet-4-20250514"
#research_model_max_tokens = 10000
compression_model = "openai:Qwen/Qwen2.5-32B-Instruct"  # Qwen local endpoint
compression_model_max_tokens = 30000
final_report_model = "openai:Qwen/Qwen2.5-32B-Instruct"
